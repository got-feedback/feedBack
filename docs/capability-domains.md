...
Diagnostics live under `feedBack.chart_transform.diagnostics.v1` and contain provider ids/labels, the active provider and its selection source, install state, and the last redacted failure — never song filenames, titles, arrangement names, or chart data.
